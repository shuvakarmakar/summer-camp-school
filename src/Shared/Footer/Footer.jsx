...
const Footer = () => {
    return (
        <footer className="footer footer-center p-16 bg-gradient-to-r from-blue-900 to-blue-600 text-white">
            <div className="flex items-center justify-center">
                <img src={logo} style={{ height: 80, width: 200 }} alt="" />
                <p className="font-bold text-white ml-2">
                    Summer Camp School <br />Reliable Learning Zone
                </p>
            </div>
